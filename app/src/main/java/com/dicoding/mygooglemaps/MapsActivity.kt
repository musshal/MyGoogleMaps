...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
     ...
     * This is where we can add mar
     * kers or lines, add listeners or move the camera. In this case,
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney))
    ...
    private fun addManyMarker() {
        ...
        tourismPlace.forEach { tourismPlace ->
            ...
            mMap.addMarker(MarkerOptions().position(latLng).title(tourismPlace.name))
    ...
    private fun setMapStyle() {
        try {
            val success = mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(
                this,
                R.raw.map_style)
            )
